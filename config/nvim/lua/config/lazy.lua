...
require("lazy").setup({
  spec = {
    ...
    -- Formatting plugins
    -- LazyVim renombró `formatting.biome` a `lang.typescript.biome` (avisaba al arrancar)
    ...
    -- angular y astro quitados (2026-08-17): no hay ningún proyecto que los use y
    -- sus LSP ocupaban 126 MB en Mason. Para recuperarlos, descomenta y :Lazy sync
