...
return {
  ...
  },
  {
    ...
    -- Viene del extra lazyvim.plugins.extras.lang.markdown. Abre la vista previa
    -- en el navegador y ocupa 62 MB. Ya usas render-markdown.nvim, que renderiza
    -- dentro del propio buffer, así que sobra. Desactivado el 2026-08-17.
